...
## Physical mediums
export PhysicalMedium, outgoing_basis_function, regular_basis_function, outgoing_translation_matrix, estimate_regular_basisorder, basisorder_to_basislength, basis_coefficients, basislength_to_basisorder, internal_field, check_material

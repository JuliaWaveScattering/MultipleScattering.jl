...
@testset "Summary" begin
    ...
    @testset "Particle test" begin
        ...
        particles1 = random_particles(volfrac, radius, shape, seed1)
        particles1a = random_particles(volfrac, radius, shape, seed1)
        particles2 = random_particles(volfrac, radius, shape, seed2)
